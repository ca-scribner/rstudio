...
public interface PreferencesPaneConstants extends com.google.gwt.i18n.client.Constants {
  ...
  @Key("Editing_diagOtherLabel")
  String Editing_diagOtherLabel();
  ...
  @Key("Editing_diagShowLabel")
  String Editing_diagShowLabel();
  ...
  @Key("Editing_diagnosticsPanel")
  String Editing_diagnosticsPanel();
  ...
  @Key("Editing_editSnippets")
  String Editing_editSnippets();
  ...
  @Key("Editing_executionLabel")
  String Editing_executionLabel();
  ...
  @Key("Editing_headerLabel")
  String Editing_headerLabel();
   ...
   */
  @DefaultStringValue("Other Languages")
  @Key("Editing_otherLabel")
  String Editing_otherLabel();
  ...
  @Key("Editing_otherTip")
  String Editing_otherTip();
   ...
   */
  @DefaultStringValue("General")
  @Key("Editing_savePanel")
  String Editing_savePanel();
  ...
  @Key("Editing_savePanel_action")
  String Editing_savePanel_action();
  ...
  @Key("Editing_savePanel_autosave")
  String Editing_savePanel_autosave();
  ...
  @Key("Editing_serializationLabel")
  String Editing_serializationLabel();
  ...
  @Key("Editing_snippetHelp_rstudioLinkName")
  String Editing_snippetHelp_rstudioLinkName();
  ...
  @Key("Editing_snippetHelp_title")
  String Editing_snippetHelp_title();
  ...
  @Key("Editing_snippetsLabel")
  String Editing_snippetsLabel();
  ...
  @Key("Editing_tabPanel")
  String Editing_tabPanel();
  ...
  @Key("Editing_tabPanel_completionPanel")
  String Editing_tabPanel_completionPanel();
  ...
  @Key("Editing_tabPanel_diagnosticsPanel")
  String Editing_tabPanel_diagnosticsPanel();
  ...
  @Key("Editing_tabPanel_displayPanel")
  String Editing_tabPanel_displayPanel();
   ...
   */
  @DefaultStringValue("Editing")
  @Key("Editing_tabPanel_editingPanel")
  String Editing_tabPanel_editingPanel();
  ...
  @Key("Editing_tabPanel_savePanel")
  String Editing_tabPanel_savePanel();
   ...
   */
  @DefaultStringValue("R and C/C++")
  @Key("Editing_completionPanel")
  String Editing_completionPanel();
